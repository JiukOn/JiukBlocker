...
function processElement(el) {
  ...
  if (blockAdsSpam && el.querySelector('[data-testid="placementTracking"]')) {
  ...
  const text = `${textEl ? textEl.innerText : ''} ${userEl ? userEl.innerText : ''}`.trim();
...
function processDOM() {
  document.querySelectorAll('article[data-testid="tweet"]').forEach(processElement);
}
